    ...
    private void Start()
    {
        switch (GameManager.Instance.CurrentChapter)
        {
            case GameManager.ChapterType.Aries:
                SetTalkScene(5, "Sprites/S_BG_01_Aries", "Sprites/S_CN_Aries", "Sprites/Character/S_C_Kumal_Standing1");
                break;

            case GameManager.ChapterType.Taurus:
                SetTalkScene(10, "Sprites/S_BG_02_Taurus", "Sprites/S_CN_Taurus", "Sprites/Character/S_C_Taurus_Standing1");
                break;

            case GameManager.ChapterType.Gemini:
                SetTalkScene(5, "Sprites/S_BG_03_Gemini", "Sprites/S_CN_Gemini", "Sprites/Character/S_C_Gemini_Standing1");
                break;

            case GameManager.ChapterType.Cancer:
                SetTalkScene(5, "Sprites/S_BG_04_Cancer", "Sprites/S_CN_Cancer", "Sprites/Character/S_C_Dub_Standing1");
                break;

            case GameManager.ChapterType.Leo:
                SetTalkScene(5, "Sprites/S_BG_05_Leo", "Sprites/S_CN_Leo", "Sprites/Character/S_C_Urgula_Standing1");
                break;

            case GameManager.ChapterType.Virgo:
                SetTalkScene(5, "Sprites/S_BG__06_Virgo", "Sprites/S_CN_Virgo", "Sprites/Character/S_C_Kumal_Standing1");
                break;
        }
